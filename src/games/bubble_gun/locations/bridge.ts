...
export class BridgeLocation extends Location {
  ...
  public getDescription(game) {
    return parajoin([
      ...
      [
        snl`There are strange glowing bubbles stuck to all the metal surfaces here. The power is still out all over the streets, but magically, the bubbles are
        providing pretty good light!`,
        snl`There's no way out of town right now, Bubble Gun World Police have blocked the road to prevent anyone from using the road. A power outage in the
        streets has caused all the street lights to turn off in this area. The Police are saying it's too dark and unsafe to let anyone try to cross.`,
        snl`Barely visible in the darkness, hundreds of magnets are stuck to all the metal surfaces of the bridge.`,
      ...
      snl`The police have put up signs all along the bridge that say BRIDGE IS OUT!` + [
        ...
        snl` The now-obsolete signs are clearly legible in the light of the magical glowing bubbles that you blasted. Neat!`,
      ][this.isDark ? 0 : 1],
    ]);
  }
      ...
      () => {
        if (this.isDark) {
          return new KeywordResponse({
            text: snl`The police officers assigned to watch the road here see you try to cross, and they don't let you. They tell you it's for your "safety."`,
          });
        } else {
          return this.followExit(
            NORTH,
            snl`Today, Bubble Gun World Police are in a good mood. It is likely because of the magical glowing bubbles which are stuck to almost every part of
            the bridge: they create joyful feelings in their hearts. You are free to cross the bridge. So long, Bubble Gun World!`,
          );
        }
      },
    );
