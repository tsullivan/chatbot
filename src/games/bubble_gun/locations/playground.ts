...
export class PlaygroundLocation extends Location {
  ...
  public getDescription(game: Adventure) {
    return p([
      s`This playground is right in the center of Bubble Gun World. It has things that are fun for kids, and there's a ladder to a tree fort!!!`,
      s`Off the corner of the road, there's a bridge leading out of Bubble Gun World.`,
      s`Nearby is also an Electronics store, a Soaps store, and a Magnets store. I hope you like stores! There are a lot of stores in this game. But guess
      what: everything in them is FREE!!`,
      [
        s`Bubble Gun world is very dark right now. All the power seems to be off in this entire neighborhood.`,
        s`Bubble Gun world is still sort-of dark out. All the power is still off, but now there is a nice ambient light coming from LEDs which are stuck to
        metal structures of the playground with magnets, and surrounded by soapy bubbles.`,
      ][this.isDark ? 0 : 1],
      [
        s`It's a pretty normal-looking playground, with the typical offerings of swings, a slide, and jungle gyms. There's even a tree fort!`,
        s`Hundreds of magnets are stuck to all the metal surfaces of the playground.`,
        s`LED throwies are stuck to hundreds of magnets which cover all the metal surfaces of the playground. The LED's are making this place look really nice!`,
  ...
  public setLocationKeywords(game: Adventure) {
      ...
      this.addKeyword('THROW_LED', 'Throw the LED throwie at stuff in the playground', () => {
        if (this.isMagneted) {
          ...
          return new KeywordResponse({
            text: p([
              s`You take the LED throwie in hand, and focus on your target: one of the magnets which has been stuck to the playground. You wind up your pitch
              ...
              s`Strangely, you still have another LED in your pocket. You can benefit from the magical powers of the LED throwie by throwing it an infinite
              number of times.`,
            ]),
          });
        } else {
          return new KeywordResponse({
            text: p([
              s`You take the LED throwie in hand, and focus. You wind up your pitch and hurl it mightily at the public use structure. It bounced off! Hmm.`,
              s`To save you some time, I'll have you pick it up again. There you go: you still have it.`,
            ]),
          });
        }
      });
    ...
    if (game.inInventory(BUBBLE_GUN) && bubbleGunItem.isComplete()) {
      this.addKeyword('BUBBLE_BLAST', 'Blast some bubbles at the bridge', () => {
        if (this.isThrowied) {
          return new KeywordResponse({
            text: s`Bubbles Blast out! Bubbles are everywhere! They float around....and become attracted to all the LED throwies to the playground rides! The
