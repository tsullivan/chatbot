...
export class MagnetBasementLocation extends Location {
  ...
  public getDescription(game: Adventure) {
    return p([
      s`You're at the bottom of a long set of stairs, in a room with a wide, open floor, and a very tall ceiling.`,
      s`A metal box on the wall stands out as it is the only thing that makes out a shape in the room. The section of wall with the box is protected by
      ...
      [
        s`It is a very well-lit and clean place - it almost feels sterile.`,
        s`There is a lot of complicated machinery curled up in a really big hole in the floor. The room is a bit dusty now. It seems like this floor
        hasn't been opened up in a long time: maybe ever.`,
        s`An enormous machine arm has extended out of the floor, crashed through the ceiling, and crashed through both the inside of and the roof
        of the magnet store.`,
  ...
  public setLocationKeywords(game: Adventure) {
    ...
    this.addKeyword(
      ...
      () => {
        const text = s`The panel has a small screen and a button of about the same size. The screen reads one message: **STATUS: ${
          this.machineStatus
        }**.
    ...
    this.addKeyword('STATUS_CYCLE', 'Press the STATUS_CYCLE button', () => {
      ...
      case STAT_EXPOSED:
        ...
        machineText = p([
          s`The bright florescent lights suddently shut off. Red alerting lights turn on and paint the large room with red light and long
            shadows.`,
          s`The floor starts to shake, and it becomes necessary for you to grab onto the guard rail to remain standing. The floor starts to
            separate in the middle - opening like cargo doors - to reveal complicated-looking machinery beneath the floor.`,
          s`In the glow of the red light, you can still read the message on the control panel status screen. It has changed to: **STATUS: ${
            this.machineStatus
          }**`,
        ]);
        break;
      case STAT_UNDEFINED:
        ...
        machineText = p([
          s`Gears in the machinery start to slowly turn, and parts of the machine start to unfold. First, metal arms and cranks
          ...
          s`All the crashing has created a lot of debris, rubble and dust in the basement around you. But the
            control panel is still working. Now the status screen reads: **STATUS: ${
  this.machineStatus
}**`,
          s`It seems this part of the machine functionality has never been tested before. That would explain why the ceilings and roof wasn't destroyed when
            you got into town.`,
          s`The Playground and the Bridge on the map of the control panel have their targets blinking.`,
        ]);
        break;
      case STAT_IGNITED_TARGET1:
        playgroundLocation.magnite();
        machineText = p([
          s`Magnets start flying off the control panel box and the guard rail, hit the machine in the center of the room, and slide up and up the machine.
          ...
          s`Suddenly, a loud noise blasts your ears: THUDUDUDUDUDUDUDUDUDUDUDUDUDUDUDUDUD. The noise is coming from high above you, in the air above the building.`,
          s`The Playground's icon on the map changed from a target to an X.`,
      ...
      case STAT_IGNITED_TARGET2:
        ...
        storeLocation.empty();
        machineText = p([
          s`Again a loud noise blasts your ears: THUDUDUDUDUDUDUDUDUDUDUDUDUDUDUDUDUD. It's just as loud and long as last time.`,
          s`The Bridge's icon on the map changed from a target to an X.`,
          s`What. Have. You. Done.`,
        ]);
        break;
      default:
        machineText = p([
          s`When you push the button now, the machine shakes a little bit and makes some clunking sounds, but nothing happens. It seems to be out of ammunition.`,
          s`You wonder if you have just emptied the entire store of all of its magnets somehow.`,
        ]);
      }
